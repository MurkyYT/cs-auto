...
function getReleasesDescription(username, repo) {
  ...
  for (let index = 0; index < elems.length; index++) {
    ...
    if (element.nodeName == "A") {
      if (element.hasAttribute("href") && element.getAttribute("href").substring(0, "https://".length) == "https://" && element.getAttribute("href").substring(0,"https://csauto.vercel.app/".length) != "https://csauto.vercel.app/") {
